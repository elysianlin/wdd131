...
function createRecipeCard(recipe) {
	...
	const starsLabel = `Rating: ${recipe.rating} out of 5 stars`;
	...
	card.innerHTML = `
		...
		<div class="recipe-content">
			...
			<h2>${recipe.name}</h2>
			<span class="rating" role="img" aria-label="${starsLabel}">
...
function renderRecipes(list) {
	...
	list.forEach(recipe => main.appendChild(createRecipeCard(recipe)));
}
